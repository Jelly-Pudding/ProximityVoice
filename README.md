...
**ProximityVoice** is a lean Paper 26.3 plugin focused on proximity voice chat and nothing else. Although it was custom built for [minecraftoffline.net](https://www.minecraftoffline.net), any server can use it.
...
# SVC client compatibility version. The 2.6.x client for Minecraft 26.3 uses 20.
...
| `compatibility-version` | `20` | Must match what the client mod sends. The Simple Voice Chat client for Minecraft 26.3 uses 20. |
